        ...
        child: Column(
          ...
          children: [
            message.attachments.length != 0
                ? Image.network(
                    message.attachments.first.imageUrl.toString(),
                    height: 30,
                  )
                : SizedBox(),
            Container(
  ...
  Future<void> _sendMessage() async {
    if (controller.text.isNotEmpty) {
      StreamChannel.of(context).channel.sendMessage(Message(
            ...
            //         path:
            //             ('/data/user/0/com.example.stream_chat_prac/cache/671499f9-b428-4569-aae8-6cc26a03ad8b3258379068135344063.jpg'),
            //         size: 30),
            //   ),
        ...
        children: [
          GestureDetector(
            onTap: () {
              setState(() {
                imagePath =
                    ImagePicker.platform.getImage(source: ImageSource.camera);
                print(imagePath);
              });
            },
            child: Container(
